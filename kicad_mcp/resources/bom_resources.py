...
def register_bom_resources(mcp: FastMCP) -> None:
    ...
    def get_bom_resource(project_path: str) -> str:
        ...
        """
        logger.info(f"Generating BOM report for project: {project_path}")
        ...
        for file_type, file_path in bom_files.items():
            try:
                ...
                logger.info(f"Error processing BOM file {file_path}: {str(e)}")
    ...
    def get_bom_csv_resource(project_path: str) -> str:
        ...
        """
        logger.info(f"Generating CSV BOM for project: {project_path}")
        ...
        try:
            ...
            logger.info(f"Error generating CSV from BOM file: {str(e)}")
    ...
    def get_bom_json_resource(project_path: str) -> str:
        ...
        """
        logger.info(f"Generating JSON BOM for project: {project_path}")
        ...
        try:
            ...
            logger.info(f"Error generating JSON from BOM file: {str(e)}")
