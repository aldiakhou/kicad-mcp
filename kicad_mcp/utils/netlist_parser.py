...
NETLIST_LIMITATIONS = [
    "Connectivity tracing is incomplete. Nets are currently inferred from global labels and power symbols only.",
    "Connection and pattern-analysis results may be incomplete for complex schematics or hierarchical designs.",
]
...
class SchematicParser:
    ...
    def _load_schematic(self) -> None:
        ...
        if not os.path.exists(self.schematic_path):
            logger.info(f"Schematic file not found: {self.schematic_path}")
        ...
        try:
            ...
            logger.info(f"Error reading schematic file: {str(e)}")
            raise
    ...
    def parse(self) -> dict[str, Any]:
        ...
        result = {
            ...
            "limitations": NETLIST_LIMITATIONS,
...
def extract_netlist(schematic_path: str) -> dict[str, Any]:
    ...
    try:
        ...
        logger.exception("Error extracting netlist: %s", e)
        return {
            "error": str(e),
            "components": {},
            "nets": {},
